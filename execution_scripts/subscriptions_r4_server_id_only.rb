...
# Execution script: Subscriptions R4 Server Suite — Id-Only payload type
#
# Tests the Inferno Subscriptions R4 Server suite using the "Id Only
...
#
# Usage:
#   bundle exec ruby execution_scripts/subscriptions_r4_server_id_only.rb
#
# Environment:
...
PRESET_ID = 'inferno-subscriptions_r5_backport_r4_server_preset_id_only'

puts '=== Subscriptions R4 Server Suite — Id-Only Payload ==='
