...
# Execution script: Subscriptions R4 Client Suite — Full-Resource payload type
#
# Tests the Inferno Subscriptions R4 Client suite using the "Inferno Subscription
# R4 Client Full-Resource Preset".  This script plays the role of the FHIR
# client under test, performing the two manual steps that a human tester would
# ordinarily do:
#
...
PRESET_ID    = 'inferno-subscriptions_r5_backport_r4_client_full_resource'
ACCESS_TOKEN = 'SAMPLE_TOKEN'
PAYLOAD_CODE = 'full-resource'

puts '=== Subscriptions R4 Client Suite — Full-Resource Payload ==='
