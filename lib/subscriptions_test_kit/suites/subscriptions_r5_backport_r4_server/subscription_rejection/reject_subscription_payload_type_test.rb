  ...
  module SubscriptionsR5BackportR4Server
    class RejectSubscriptionPayloadTypeTest < Inferno::Test
      ...
      description %(
        ...
        for a Subscription, a server SHOULD validate that the payload configuration is known and implemented by the server.
      ...
      run do
        ...
        skip_if(unsupported_info['field_value'].blank?, %(
          No subscription payload input provided.))
