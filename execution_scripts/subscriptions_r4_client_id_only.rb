...
# Execution script: Subscriptions R4 Client Suite — Id-Only payload type
#
# Tests the Inferno Subscriptions R4 Client suite using the "Inferno Subscription
# R4 Client Id-Only Preset".  This script plays the role of the FHIR client
# under test, performing the two manual steps that a human tester would
# ordinarily do:
#
...
PRESET_ID    = 'inferno-subscriptions_r5_backport_r4_client_id_only'
ACCESS_TOKEN = 'SAMPLE_TOKEN'
PAYLOAD_CODE = 'id-only'

puts '=== Subscriptions R4 Client Suite — Id-Only Payload ==='
